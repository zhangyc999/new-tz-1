...
static void ecu_init(void)
{
        ...
        sys_ecu[CA_SDT].index = 30;
        sys_ecu[CA_SDS0].index = 31;
        sys_ecu[CA_SDS1].index = 32;
        sys_ecu[CA_SDS2].index = 33;
        sys_ecu[CA_SDS3].index = 34;
        sys_ecu[CA_SDF0].index = 35;
        sys_ecu[CA_SDF1].index = 36;
        sys_ecu[CA_SDF2].index = 37;
        sys_ecu[CA_SDF3].index = 38;
        sys_ecu[CA_SDB0].index = 39;
        sys_ecu[CA_SDB1].index = 40;
        sys_ecu[CA_SDB2].index = 41;
        sys_ecu[CA_SDB3].index = 42;
        ...
        sys_ecu[CA_SDT].msg = msg_sdt;
        sys_ecu[CA_SDS0].msg = msg_sdt;
        sys_ecu[CA_SDS1].msg = msg_sds;
        sys_ecu[CA_SDS2].msg = msg_sds;
        sys_ecu[CA_SDS3].msg = msg_sds;
        sys_ecu[CA_SDF0].msg = msg_sds;
        sys_ecu[CA_SDF1].msg = msg_sdfb;
        sys_ecu[CA_SDF2].msg = msg_sdfb;
        sys_ecu[CA_SDF3].msg = msg_sdfb;
        sys_ecu[CA_SDB0].msg = msg_sdfb;
        sys_ecu[CA_SDB1].msg = msg_sdfb;
        sys_ecu[CA_SDB2].msg = msg_sdfb;
        sys_ecu[CA_SDB3].msg = msg_sdfb;
