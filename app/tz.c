...
void tz(void)
{
        msg_core = msgQCreate(128, sizeof(CMD), MSG_Q_FIFO);
        ...
        msg_tls = msgQCreate(128, sizeof(CAN), MSG_Q_FIFO);
        msg_vsl = msgQCreate(128, sizeof(CAN), MSG_Q_FIFO);
        msg_psu = msgQCreate(128, sizeof(CAN), MSG_Q_FIFO);
        msg_swh = msgQCreate(128, sizeof(CAN), MSG_Q_FIFO);
        msg_rse = msgQCreate(128, sizeof(CAN), MSG_Q_FIFO);
        msg_swv = msgQCreate(128, sizeof(CAN), MSG_Q_FIFO);
        msg_prp = msgQCreate(128, sizeof(CAN), MSG_Q_FIFO);
        msg_xyz = msgQCreate(128, sizeof(CAN), MSG_Q_FIFO);
        msg_shd = msgQCreate(128, sizeof(CAN), MSG_Q_FIFO);
        msg_mom = msgQCreate(128, sizeof(CAN), MSG_Q_FIFO);
        msg_gen = msgQCreate(128, sizeof(CAN), MSG_Q_FIFO);
